...
//
//  static const String MOVIE_STORE_NAME = 'shows';
//  final _store = stringMapStoreFactory.store(MOVIE_STORE_NAME);
//
//  SeriesRepository( this.tracktTvSerieClient,
...
//      await _store.record(movie.ids.slug).update(await db, movie.toJson());
//
...
//    var related = await Common.completeSeriesDataFromTracktList(
//        showsTrackt, tmdbClient, "related");
